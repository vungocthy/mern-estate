    ...
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
            <div className='flex flex-col gap-4 flex-1'>
                <input onChange={handleChange} value={formData.nameL} type='text' placeholder='Name' className='border p-3 rounded-lg'id='nameL' maxLength='62' minLength='10' required/>
                <textarea onChange={handleChange} value={formData.descriptionL} type='text' placeholder='Description' className='border p-3 rounded-lg'id='descriptionL' required/>
                <input onChange={handleChange} value={formData.addressL} type='text' placeholder='Address' className='border p-3 rounded-lg'id='addressL'  required/>
